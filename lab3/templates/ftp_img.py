...
class Server:
    ...
    def connection_handler(self, client):
        ...
        try:
            ...
            # file = open(filename, 'br').read()
            # with open(filename, "br") as file:
            #     file_base64 = base64.b64decode(file.read())
        ...
        # file_bytes = base64.b64encode(MSG_ENCODING)
        # file_bytes = file.encode(MSG_ENCODING)
        file_size_bytes = len(file)
        # file_size_bytes = len(file_base64)
        ...
        # pkt = file_size_field + file_base64        
        try:
...
class Client:
    ...
    OUTPUT_FILE = LOCAL_FILE_NAME + ".base64"
    ...
    def get_file(self):
        ...
        try:
            ...
            print("Received {} bytes. Creating file: {}" \
                  .format(len(recvd_bytes_total), Client.LOCAL_FILE_NAME + ".base64"))
            
            with open(filename_field, "br") as file:
                file_base64 = base64.b64encode(file.read())

            # Write the encoded image to a file.
            with open(Client.OUTPUT_FILE, "+wb") as file:
                file.write(file_base64)

            # Read the base64 encoded image and decode it.
            with open(Client.OUTPUT_FILE, "r") as file:
                file_decoded = base64.b64decode(file.read())
            
            # Recover the original file and write it 
            with open(Client.RECONSTRUCTED_FILE, '+wb') as f:
